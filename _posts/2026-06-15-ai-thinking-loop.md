...
|---|---|---|
| 10 minutes | Opening | Surface teacher concerns and reframe them as design signals |
| 15 minutes | Loop Walkthrough | Understand the five stages and evidence of thinking |
| 20 minutes | Teacher Experience | Use the loop as learners with a sample task |
| 10 minutes | Debrief | Name what the loop made visible |
| 25 minutes | Redesign Studio | Build loop requirements for an existing classroom task |
| 10 minutes | Share + Commit | Use feedback and identify a two-week implementation step |
