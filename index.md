...
# 🚀 Helping Schools Integrate Computing Education Into Everyday Instruction

Practical systems for K–12 schools to strengthen core contents through various computing education approaches without adding extra workload.

<div style="margin-top: 20px;">
  <a href="mailto:felalberto@gmail.com?subject=Consultation%20Request" 
     style="display:inline-block;padding:10px 18px;background:#2563eb;color:white;border-radius:6px;text-decoration:none;font-weight:600;">
    📅 Book a Call
  </a>

  <a href="#how-it-works" 
     style="display:inline-block;padding:10px 18px;border:2px solid #2563eb;color:#2563eb;border-radius:6px;text-decoration:none;font-weight:600;margin-left:10px;">
    ⚙️ See How It Works
  </a>
</div>
---
...
📧 Email: felalberto@gmail.com 
🔗 LinkedIn: [Felix Alberto](https://www.linkedin.com/in/felix-alberto-78763a36/)
